...
<head>
    ...
    <script src="../js/registroPer.js" defer></script>
            ...
            <ul class="nav">
				...
				<li><a href="">Registro</a>
					<ul>
                        ...
                        <li><a href="../secciones/RPrograma.php">Programa</a></li>
    ...
    <div class="cuerpo">
        ...
        <div id="contenido1" class="contenido1">
            <div class="cont1">
                ...
                <p>FECHA DE INGRESO A LA INSTITUCIÓN:</p>
                <input type="date" id="dateIns" name="dateIns" placeholder="">
                
                <p>RFC: <span class="mdi mdi-help-circle-outline icon-ayuda" title="Se estructura de 4 letras al inicio, seguido de 6 numeros y por ultimo se sigue la homoclave de 3 caracteres conformado por numero y letras"></span></p>
                <input type="text" id="rfc" name="rfc" placeholder="">
                <p>NOMBRE:</p>
                <input type="text" id="nombre" name="nombre" placeholder="">
                <p>APELLIDO PATERNO:</p>
                <input type="text" id="ap" name="ap" placeholder="">
                <p>APELLIDO MATERNO:</p>
                <input type="text" id="am" name="am" placeholder="">

                <p>GENERO:</p>
                <select id="genero" class="combobox2">
                    <option value="M">Masculino</option>
                    <option value="F">Femenino</option>
                </select>

                <p>FUNDADOR:</p>
                <select id="fundador" class="combobox2">
        ...
        <div id="contenido5" class="contenido5">
            <div class="cont1">
                
                <p>PLAZA:</p>
                <select id="plaza" class="combobox2">
                ...
                <p>NUMERO DE ASOCIASIONES:</p>
                <input type="number" id="asocioaciones" name="asocioaciones" placeholder="">

                <p>CERTIFICADO:</p>
                <select id="certificado" class="combobox2">
                    <option value="Si">Si</option>
                    <option value="No">No</option>
                </select>

                <p>MAXIMO GRADO DE ESTUDIOS:</p>
                <select id="nivel" class="combobox2">
                ...
                <p>ESTATUS:</p>
                <select id="estatus" class="combobox2">
                ...
                <button class="submit" id="siguiente">SIGUIENTE</button>
        ...
        <div id="contenido2" class="contenido2">
            <div class="cont1">
                ...
                <p>TUTOR:</p>
                <select id="tutor_activo" class="combobox2">
                    <option value="Si">Si</option>
                    <option value="No">No</option>
                </select>

                <p>LICENCIA:</p>
                <select id="licencia_activo" class="combobox2">
                    <option value="Si">Si</option>
                    <option value="No">No</option>
                </select>

                <p>PUESTO ACTUAL:</p>
                <select id="puesto_activo" class="combobox2">
                    <option value="Jefe de Proyecto de Vinculación">Jefe de Proyecto de Vinculación</option>
                    <option value="Jefe de Proyecto de Investigación">Jefe de Proyecto de Investigación</option>
                    <option value="Jefe de Proyecto Docente">Jefe de Proyecto Docente</option>
                ...
                <input type="date" id="dateAct_activo" name="dateAct" placeholder="">

                <button class="submit" id="guardarPer_activo">GUARDAR</button>

            </div>
        </div>

        <div id="contenido3" class="contenido3">
            <div class="cont1">

                <p>LICENCIA:</p>
                <select id="licencia_sabatico" class="combobox2">
                    <option value="Si">Si</option>
                    <option value="No">No</option>
                </select>

                <p>PUESTO ACTUAL:</p>
                <select id="puesto_sabatico" class="combobox2">
                    <option value="Jefe de Proyecto de Vinculación">Jefe de Proyecto de Vinculación</option>
                    <option value="Jefe de Proyecto de Investigación">Jefe de Proyecto de Investigación</option>
                    <option value="Jefe de Proyecto Docente">Jefe de Proyecto Docente</option>
                    <option value="Jefe de Departamento">Jefe de Departamento</option>
                ...
                <p>FECHA DE ACTUALIZACIÓN:</p>
                <input type="date" id="dateAct_sabatico" name="dateAct" placeholder="">

                <button class="submit" id="guardarPer_sabatico">GUARDAR</button>

            </div>
        </div>

        <div id="contenido4" class="contenido4">
            <div class="cont1">

                <p>FECHA DE ACTUALIZACIÓN:</p>
                <input type="date" id="dateAct_otro" name="dateAct" placeholder="">

                <button class="submit" id="guardarPer_otros">GUARDAR</button>

            </div>
        </div>

        <div id="contenido6" class="contenido6">

            <div class="cont0">

                <p>RFC DEL PERSONAL: </p>
                <select id="clvEstatus" class="combobox2">
                    <?php foreach ($personalHoy as $personalHoy): ?>
                        <option value=<?php echo $personalHoy['CLV_EST']; ?>><?php echo $personalHoy['RFC_PERS']; ?></option>
                    <?php endforeach; ?> 
                </select>
            ...
            <div id="cont1" class="cont1">
                ...
                <b class="negritas">DOCUMENTOS - NIVEL DE EDUCACIÓN</b>

                <p>NOMBRE DEL DOCUMENTO:</p>
                <input type="text" id="nomDocN" name="nomDocN" placeholder="">

                <p>SUBIR ARCHIVO:</p>
                <form id="uploadForm_nivel" enctype="multipart/form-data">
            ...
            <div id="cont2" class="cont2">
                ...
                <b class="negritas">DOCUMENTOS - CERTIFICACIONES</b>

                <p>NOMBRE DEL DOCUMENTO:</p>
                <input type="text" id="nomDocC" name="nomDocC" placeholder="">

                <p>SUBIR ARCHIVO:</p>
                <form id="uploadForm_certificacion" enctype="multipart/form-data">
                    <input type="file" name="pdfFile" accept="application/pdf" required>
                    <button type="submit">Subir PDF</button>
                </form>
                <div id="message"></div>
            ...
            <div id="cont3" class="cont3">

                <b class="negritas">DOCUMENTOS - SABATICO</b>

                <p>NOMBRE DEL DOCUMENTO:</p>
                <input type="text" id="nomDocS" name="nomDocS" placeholder="">

                <p>SUBIR ARCHIVO:</p>
                <form id="uploadForm_sabatico" enctype="multipart/form-data">
                    <input type="file" name="pdfFile" accept="application/pdf" required>
                    <button type="submit">Subir PDF</button>
                </form>
                <div id="message"></div>
        ...
        <div id="contenido7" class="contenido7">
            
            <div class="cont4">

                <p>AÑO EN EL QUE OBTUVO EL ULTIMO NIVEL DE EDUCACIÓN:</p>
                <input type="number" id="year" name="dateAct" placeholder="">

                <b class="negritas">FECHA - ESTATUS</b>

                <p>INICIO:</p>
                <input type="date" id="dateEstatus_I" placeholder="">

                <p>TERMINO:</p>
                <input type="date" id="dateEstatus_F" placeholder="">

                
                <b class="negritas">FECHA - PLAZA</b>

                <p>INICIO:</p>
                <input type="date" id="datePlaza_I" placeholder="">

                <p>TERMINO:</p>
                <input type="date" id="datePlaza_F" placeholder="">

            </div>

            <div id="cont6" class="cont6">

                <b class="negritas">FECHA - PUESTO</b>

                <p>INICIO:</p>
                <input type="date" id="datePuesto_I" placeholder="">

                <p>TERMINO:</p>
                <input type="date" id="datePuesto_F" placeholder="">

            </div>

            <div id="cont8" class="cont8">

                <b class="negritas">FECHA - SABATICO</b>

                <p>INICIO:</p>
                <input type="date" id="dateSab_I" placeholder="">

                <p>TERMINO:</p>
                <input type="date" id="dateSab_F" placeholder="">

            </div>

            <div id="cont9" class="cont9">

                <b class="negritas">FECHA - TUTOR</b>

                <p>INICIO:</p>
                <input type="date" id="dateTutor_I" placeholder="">

                <p>TERMINO:</p>
                <input type="date" id="dateTutor_F" placeholder="">

            </div>

            <div class="cont7">

                <button class="submit" id="guardarExtra">GUARDAR</button>
