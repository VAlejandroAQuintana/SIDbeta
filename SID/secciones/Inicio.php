...
<body>
    ...
    <div class="cuerpo">
        <div class="contenido">
            <h3>Sistema de Información Departamental</h3>
        </div>
        <div class="contenido1">
            <h4>Proposito</h4>
            <p>Contar con un sistema digital de indicadores departamentales (SID) que muestren la evolución institucional con la finalidad de atender de manera oportuna los requerimientos de información que demandan los  organismos externos principalmente.</p>
        </div>
    </div>
