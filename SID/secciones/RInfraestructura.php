...
<head>
    ...
    <script src="../js/registroInfra.js" defer></script>
...
<body>
    ...
    <div class="cuerpo">
        <div class="contenido">
            <h3>REGISTRO INFRAESTRUCTURA</h3>
        </div>
        <div class="contenido1">
            <div class="cont1">
                ...
                <p>Laboratorios actuales:</p>
                <input type="number" id="laboratorio" name="laboratorio" placeholder="">
                <p>Talleres actuales:</p>
                <input type="number" id="taller" name="taller" placeholder="">
                <p>Acervos bibliograficos actuales:</p>
                <input type="number" id="biblio" name="biblio" placeholder="">
                <p>Proyectores actuales:</p>
                <input type="number" id="proyector" name="proyector" placeholder="">
                <p>Servidores actuales:</p>
                <input type="number" id="servidor" name="servidor" placeholder="">
                <p>Computadoras actuales:</p>
                <input type="number" id="computadora" name="computadora" placeholder="">

                <p>Fecha actual:</p>
                <input type="date" id="fecha" name="fecha" placeholder="">

                <button class="submit" id="guardarInfra">Ingresar</button>
