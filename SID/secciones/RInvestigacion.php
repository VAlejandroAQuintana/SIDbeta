...
<head>
    ...
    <script src="../js/registroInves.js" defer></script>
    <?php session_start();?>
</head>
<body>
    ...
    <div class="cuerpo">
        <div class="contenido">
            <h3>REGISTRO INVESTIGACIÓN</h3>
        </div>
        <div class="contenido1">
            <div class="cont1">

                <p>PERSONAL:</p>
                <select id="rfc" class="combobox2">
                    <?php foreach ($personal as $personal): ?>
                        <option value=<?php echo $personal['RFC_PERS']; ?>><?php echo $personal['RFC_PERS']; ?></option>
                    <?php endforeach; ?> 
                </select>

                <p>SNI:</p>
                <select id="sni" class="combobox2">
                    <option value="Si">Si</option>
                    <option value="No">No</option>
                </select>

                <p>PATENTE:</p>
                <select id="patente" class="combobox2">
                    <option value="Si">Si</option>
                    <option value="No">No</option>
                </select>

                <p>CUERPO ACADEMICO:</p>
                <select id="academico" class="combobox2">
                    <option value="Si">Si</option>
                    <option value="No">No</option>
                </select>

                <p>LINEA DE INVESTIGACIÓN:</p>
                <select id="linea" class="combobox2">
                    <option value="Si">Si</option>
                    <option value="No">No</option>
                </select>

                <p>BECA ACADEMICA:</p>
                <select id="beca" class="combobox2">
                    <option value="Si">Si</option>
                    <option value="No">No</option>
                </select>

                <p>PERFIL DESEABLE:</p>
                <select id="perfil" class="combobox2">
                    <option value="Si">Si</option>
                    <option value="No">No</option>
                </select>
                ...
                <button class="submit" id="guardarInves">Ingresar</button>
