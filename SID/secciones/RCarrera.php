...
<head>
    ...
    <script src="../js/registroCarr.js" defer></script>
...
<body>
    ...
    <div class="cuerpo">
        <div class="contenido">
            <h3>REGISTRO CARRERA</h3>
        </div>
        <div class="contenido1">
            <div class="cont1">

                <p>Clave de la carrera:</p>
                <input type="text" id="clv_carrera" name="clv_carrera" placeholder="">

                <p>Nombre de la carrera:</p>
                <input type="text" id="nom_carrera" name="nom_carrera" placeholder="">

                <p>Numero de convenios:</p>
                <input type="number" id="convenio" name="convenio" placeholder="">
                <p>Numero de servicios:</p>
                <input type="number" id="servicio" name="servicio" placeholder="">
                <p>Numero de eventos:</p>
                <input type="number" id="evento" name="evento" placeholder="">
                
                <p>Fecha actual:</p>
                <input type="date" id="fecha" name="fecha" placeholder="">

                <button class="submit" id="guardarCarr">Ingresar</button>
