...
<body>
    ...
    <div class="cuerpo">
        <div class="contenido">
            <h3>REGISTRO ALUMNADO</h3>
        </div>
        <div class="contenido1">
            <div class="cont1">
                <p>Carrera:</p>
                <select id="carr" class="combobox2">
                    <?php foreach ($carrera as $carrera): ?>
                        <option value=<?php echo $carrera['CLV_CARR']; ?>><?php echo $carrera['CLV_CARR']." - ".$carrera['CARR_NOM']; ?></option>
                    <?php endforeach; ?> 
                </select>
                <p>Cantidad de alumnos becados:</p>
                <input type="number" id="becados" name="becados" placeholder="becados">
                <p>Cantidad de alumnos residentes:</p>
                <input type="number" id="residentes" name="residentes" placeholder="residentes">
                <p>Cantidad de alumnos titulados:</p>
                <input type="number" id="titulados" name="titulados" placeholder="titulados">
                <p>Fecha actual:</p>
                <input type="date" id="fecha" name="fecha" placeholder="">

                <button class="submit" id="guardarAlum">Ingresar</button>
