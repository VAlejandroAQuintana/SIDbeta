...
<body>
    ...
    <div class="toolbar-gray" style="background-color: #d3d3d3; padding: 10px; margin-top: 20px; text-align: center;">
        <h2 style="margin: 0;">Plantilla Infraestructura</h2>
    </div>

    <div class="top-bar">
        <div class="filter-select">
                <label for="sort">Carrera: </label>
                <select id="sort">
                <?php if (!empty($carreraL)): ?>
                <?php foreach ($carreraL as $carrera): ?>
                    <option value=<?php echo $carrera['CLV_CARR']; ?>><?php echo $carrera['CARR_NOM']; ?></option>
                ...
                <button type="button" class="filter-button" id="btnConfirmar">Confirmar <i class="arrow"></i></button>
        </div>
    </div>
    
    <div class="content" style="background-image: url('ruta/a/tu/imagen_fondo.jpg'); background-size: cover;">
        <div class="section">
            <div class="info-box">
                <table class="info-table" id="infoTable">
                    <tr>
                        <td><strong>Fecha más reciente:</strong></td>
            ...
            <!--<div class="croquis-section">
                ...
                <img src="../images/croquis.png" alt="Imagen del Croquis" class="croquis-image">
            </div>-->
        </div>
    </div>
    </div>
    ...
    <script src="../js/VistaF.js"></script>
</body>
</html>
